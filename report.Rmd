...
Of the bets that have been matched, there have been `r n_matched_winners` winners and `r n_matched_losers` losers. That means that `r matched_win_perc`% of matched bets have been winners. Of the bets that have not been matched, there have been `r n_unmatched_winners` winners and `r n_unmatched_losers` losers. That means that `r unmatched_win_perc`% of unmatched bets have been winners. Unmatched bets have saved us `r pts_saved_by_unmatched` points on losers but cost us `r pts_lost_by_unmatched` on winners, so overall unmatched bets have `r unmatched_desc` us `r abs(pts_profit_by_unmatched)` points.